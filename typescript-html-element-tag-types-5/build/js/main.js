...
let f = 'world';
let e = 'world';
let dd = 'world'; // (veya: 'world' as One)  → *type assertion*
let ff = 'world'; // → *type annotation*
...
10; //two assertions in a row..double-casting or force-casting diye de geciyor 
...
const img9 = document.querySelector('#img');
export {};
